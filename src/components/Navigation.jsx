...
export const Navigation = () => {
    ...
    return (
        <section className='section is-halfheight hero-1'>
            <div className='container'>
                <nav className='navbar is-transparent' role='navigation' aria-label='main navigation'>
                    ...
                    <div id='navbarBasicExample' className='navbar-menu'>
                        <div className='navbar-start'>
                            ...
                            <a className='navbar-item has-text-white'> Services </a>
                            ...
                            <div className='navbar-item has-dropdown is-hoverable'>
                                ...
                                <div className='navbar-dropdown'>
                                    ...
                                    <a className='navbar-item'> Dolor </a>
                ...
                <div className='columns pt-6'>
                    <div className='column mt-6'>
                        <h1 className='is-size-1 has-text-white'>Lorum Ipsum &amp; Dolor Sit Amet!</h1>
                        <p className='has-text-white'>Lorem ipsum, dolor sit amet</p>
                        <button className='is-warning button mt-3'>Learn more</button>
                    </div>
                    <div className='column mt-6'>
